...
class TextAnalyzer:
    ...
    def archive(self):
        with zipfile.ZipFile("D://uni//igi//253503_ANKUDA_01//253503_ANKUDA_01//IGI//LR4//LR4//task2//archive.zip", "w") as z:
            z.write(self.filename)
        with zipfile.ZipFile("D://uni//igi//253503_ANKUDA_01//253503_ANKUDA_01//IGI//LR4//LR4//task2//archive.zip", "r") as z:
...
def task2_run():
    ...
    print(
        f"1. Sentences count: {sentences_count}\n"
        f"2. Narrative sentences count: {narr_sentences}\n"
        f"3. Interrogative sentences count: {interrogative_sentences}\n"
        f"4. Imperative sentences count: {imperative_sentences}\n"
        f"5. Average word length: {average_sentence_length}\n"
        f"6. Average sentence length: {average_word_length}\n"
        f"7. Smileys count: {num_smiles}\n"
        f"8. All capital letters: {a.find_all_caps()}\n"
        f"9. Text after sequence replacement:\n {a.replace_sequence()}\n"
        f"10. Number of maximum length words: {max_length_words_count}\nMaximum word length: {max_length}\n"
        f"11. Words followed by punctuation: {a.words_followed_by_punctuation()}\n"
        f"12. Longest word that ends with 'e': {a.longest_word_ending_with_e()}\n"
    )
