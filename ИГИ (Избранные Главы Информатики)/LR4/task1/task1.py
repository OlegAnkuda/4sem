...
def task1_run():
    ...
    while True:
        ...
        match choice:
            ...
            case 6:
                product_summary.save_to_csv("D://uni//igi//253503_ANKUDA_01//253503_ANKUDA_01//IGI//LR4//LR4//task1//products.txt")
            case 7:
                product_summary = ProductSummary.load_from_csv("D://uni//igi//253503_ANKUDA_01//253503_ANKUDA_01//IGI//LR4//LR4//task1//products.txt")
                for product in product_summary.products:
                    print(product.name, product.exporting_country, product.count)
            case 8:
                product_summary.save_to_pickle("D://uni//igi//253503_ANKUDA_01//253503_ANKUDA_01//IGI//LR4//LR4//task1//products.pkl")
            case 9:
                product_summary = ProductSummary.load_from_pickle("D://uni//igi//253503_ANKUDA_01//253503_ANKUDA_01//IGI//LR4//LR4//task1//products.pkl")
                for product in product_summary.products:
                    print(product.name, product.exporting_country, product.count)
